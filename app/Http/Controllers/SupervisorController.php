    ...
    public function dashboard(Request $request)
{
    ...
    return view('supervisor.dashboard', compact('title', 'accountOfficers','nasabahs', 'suratPeringatans', 'cabangs', 'wilayahs', 'currentUser'));
}
...
public function update(Request $request, $no)
    {
        ...
        return redirect()->route('supervisor.dashboard')->with('success', 'Data updated successfully');
    }
